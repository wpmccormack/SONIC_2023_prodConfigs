...
options.register("config", "step2_PAT_SONIC_Production_Workflow_Run2", VarParsing.multiplicity.singleton, VarParsing.varType.string, "cmsDriver-generated config to import")
